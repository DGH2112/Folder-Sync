  ...
  begin
    With TIniFile.Create(FRootKey) Do
      Begin
        ...
        Try
          ReadSection(strFldrSyncOptions[fsoCloseIFNoFilesAfterComparison].FINISection, sl);
          If sl.Count = 0 Then // Check for OLD options
            Begin
            ...
            Begin
              ...
              For j := Low(TFldrSyncOption) To High(TFldrSyncOption) Do
                If ReadBool(strFldrSyncOptions[j].FINISection,
                  strFldrSyncOptions[j].FINIKey, strFldrSyncOptions[j].fDefault) Then
  ...
  begin
    With TIniFile.Create(FRootKey) Do
      Begin
        ...
        For j := Low(TFldrSyncOption) To High(TFldrSyncOption) Do
          WriteBool(strFldrSyncOptions[j].FINISection,
            strFldrSyncOptions[j].FINIKey, j In FFldrSyncOptions);
